...
public class StepDefinitionsRestaurant {
    ...
    @Then("the client receives a Restaurant object")
    public void the_client_receives_a_restaurant_object() throws IOException {
        // Write code here that turns the phrase above into concrete actions
    ...
    @Then("the client receives a list of Restaurant objects")
    public void the_client_receives_a_list_of_restaurant_objects() throws IOException {
        String json = EntityUtils.toString(latestHttpResponse.getEntity());
